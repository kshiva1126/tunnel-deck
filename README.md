...
Add `--json` to any command for automation. Daemon errors use stable exit
statuses: 2 for invalid input, 4 for a missing rule, 5 for a conflict, 6 for an
unavailable operation, and 70 for an internal failure.
